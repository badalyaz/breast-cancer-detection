...
CollectionDirectory = 'C:\Users\data_science\Desktop\Projects\BreastCancer\SFUniversity\';

% These are for the other script. NOTICE THE BRACKETS DIRECTION. ALSO
% NOTICE A SEMICOLON IN FIRST VAR.
pathToJPEGandDDSM2RAWfiles = 'C:/Users/data_science/Desktop/Projects/BreastCancer/SFUniversity/';
cygwinLocation = 'C:\cygwin\bin\bash.exe';
            ...
            if(~strcmp(a{1,i}, '.') && ~strcmp(a{1,i}, '..') && a{5,i} == 1)
                ...
                for j = 1:length(imageFiles)
                    ...
                    try
                        ...
                        disp(strcat(["Error On Conversion",j]))
                        continue
                    end
